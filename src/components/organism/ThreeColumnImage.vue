          ...
          <div class="flex flex-col lg:flex-row lg:gap-x-10 gap-y-10 mb-10">
              <div v-for="(item, id) in items" :key="id" class="flex-1">
                  ...
                  <div class="text-neutral-2 apercu-light prose">
                    <p class="text-gray-500">Uplift productivity and boost morale with friendly competitions to keep inside sales teams hitting their KPIs.</p>
                  </div>
              </div>
          </div>
      </div>
            ...
            return [
                {
                    ...
                    contentText: 'Uplift productivity and boost morale with friendly competitions to keep inside sales teams hitting their KPIs.',
                    imagePanel: {
                        "_type": "image",
                        "asset": {
